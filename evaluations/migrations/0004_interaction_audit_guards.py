...
MODELS = ("EvaluationExposure", "HumanFeedback", "FeedbackOutcomeLink")
...
class Migration(migrations.Migration):
    dependencies = [("evaluations", "0003_evaluationexposure_humanfeedback_feedbackoutcomelink_and_more")]
