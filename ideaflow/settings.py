...
MIDDLEWARE = [
    ...
    'ideas.middleware.TrackLastSeenMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'ideas.context_processors.help_inbox',
            ],
        },
    },
]
...
IDEAFLOW_EXECUTION_CAPTURE_SINCE = os.getenv('IDEAFLOW_EXECUTION_CAPTURE_SINCE', '')
IDEAFLOW_EXECUTION_PAYLOAD_BACKUP_ROOT = os.getenv('IDEAFLOW_EXECUTION_PAYLOAD_BACKUP_ROOT', '')
...
IDEAFLOW_EXECUTION_API_MAX_BYTES = env_int(
    'IDEAFLOW_EXECUTION_API_MAX_BYTES', 64 * 1024 * 1024
)
...
IDEAFLOW_SEMANTIC_MAX_INPUT_CHARS = env_int(
    'IDEAFLOW_SEMANTIC_MAX_INPUT_CHARS', 12000
)
